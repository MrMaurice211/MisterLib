...
/**
 * A fast and easy way to convert legacy or B+ formatted chat into MD's
 * ChatComponent API
 *
 * Ported over from
 * https://github.com/BananaPuncher714/BrickBoard/tree/master/io/github/bananapuncher714/brickboard/api/chat
 *
 * Find out more about B+ formatting here:
 * https://bananapuncher714.gitbook.io/brickboard/b+-style-chat-formatting
 *
...
public class ChatMessage {
	 ...
	 * @param readExtra
	 *            Whether or not to parse B+ formatting, A.K.A. hover and click
	 *            events
	 * @return
	...
	public static TextComponent getMessageFromString(String message, boolean readExtra) {
		...
		// More efficient conversion using split, as opposed to iterating over every
		// character
	...
	// Simple method to clear all formats, something that's pretty useful but not
	// implemented *cough*
