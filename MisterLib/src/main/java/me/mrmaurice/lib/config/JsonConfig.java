...
import me.mrmaurice.lib.utils.Reflections.ConsInvoker;
import me.mrmaurice.lib.utils.Reflections.MethodInvoker;
...
public class JsonConfig {
	...
	public class SerializableJsonValue extends JsonValue {
		...
		public <T extends ConfigurationSerializable> T getSer(T def) {
			if (obj == null)
				return def;
			MethodInvoker deserialize = Reflections.getMethod(def.getClass(), "deserialize", Map.class);
