...
public class CustomConfig {
	...
	// private static final ReConstructor cons =
	// Reflections.getConstructor(JsonPrimitive.class, Object.class);
	//
	...
	// ConfigSerializer<Object> ser =
	// Reflections.getClass(cs.serializer()).getConstructor().newInstance();
	...
	// JsonObject obj = new JsonParser().parse(new
	// FileReader(source)).getAsJsonObject();
	//
